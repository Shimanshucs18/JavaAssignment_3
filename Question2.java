...
public class Question2 {
    ...
    public static void main(String[] args) {
        Employyee e1 = new Employyee((double) 22, 2000.90d, "Shimanshu", "Sharma");
        Employyee e2 = new Employyee((double) 24, 98000.90d, "Barak", "Obama");
        Employyee e3 = new Employyee((double) 27, 30000.90d, "Ratan", "Tata");
